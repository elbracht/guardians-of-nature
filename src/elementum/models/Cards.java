...
public class Cards {
    ...
    public Cards() throws IOException {
        ...
        bear2.setAttack(15);
        bear2.setHealth(5);
        bear2.setImageDefault(ImageIO.read(getClass().getResourceAsStream("/elementum/assets/cards/bear.png")));
        ...
        bear3.setAttack(5);
        bear3.setHealth(15);
        bear3.setImageDefault(ImageIO.read(getClass().getResourceAsStream("/elementum/assets/cards/bear.png")));
